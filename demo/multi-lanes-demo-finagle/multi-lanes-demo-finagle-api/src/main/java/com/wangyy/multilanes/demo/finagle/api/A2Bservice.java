...
public class A2Bservice {
  public static interface Iface {
    
    public String a2b(String msg);
  }
  ...
  public static class FinagledClient extends A2Bservice$FinagleClient {
  ...
  public static class FinagledService extends A2Bservice$FinagleService {
  ...
  static class Args implements ThriftStruct {
    private static final TStruct STRUCT = new TStruct("a2b_args");
  ...
  static class Result implements ThriftStruct {
    private static final TStruct STRUCT = new TStruct("a2b_result");
