...
public class C2Dservice {
  public static interface Iface {
    
    public String c2d(String msg);
  }
  ...
  public static class FinagledClient extends C2Dservice$FinagleClient {
  ...
  public static class FinagledService extends C2Dservice$FinagleService {
  ...
  static class Args implements ThriftStruct {
    private static final TStruct STRUCT = new TStruct("c2d_args");
  ...
  static class Result implements ThriftStruct {
    private static final TStruct STRUCT = new TStruct("c2d_result");
